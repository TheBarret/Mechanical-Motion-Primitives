...
if __name__ == "__main__":
    from mmpv3 import (ICBuilder, CCBuilder, SpurGear, HookesJoint, 
    RackAndPinion, ScotchYoke, Wedge, CompoundGearTrain, OldhamCoupling, EccentricCam, CrankSlider)
    #.add(OldhamCoupling)
